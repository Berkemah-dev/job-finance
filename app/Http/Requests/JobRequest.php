...
class JobRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return ['lock_version' => ['required', 'integer', 'min:0'], 'subject' => ['required', 'string', 'max:255'],
            ...
            'service_type' => ['nullable', Rule::in(ServiceType::allowedKeys())],
            ...
            'nopen' => ['nullable', 'string', 'max:60'], 'nopen_date' => ['nullable', 'date_format:Y-m-d'], 'npe_number' => ['nullable', 'string', 'max:60'],
            'peb_number' => ['nullable', 'string', 'max:60'], 'peb_date' => ['nullable', 'date_format:Y-m-d'],
            'sk_pabean_number' => ['nullable', 'string', 'max:60'],
            'commercial_invoice_number' => ['nullable', 'string', 'max:60'], 'commercial_invoice_date' => ['nullable', 'date_format:Y-m-d'],
            'packing_list_number' => ['nullable', 'string', 'max:60'], 'packing_list_date' => ['nullable', 'date_format:Y-m-d'],
            'invoice_issuer' => ['nullable', 'string', 'max:160'],
            'invoice_amount' => ['nullable', 'string', 'max:100'],
            ...
            'container_type' => ['nullable', Rule::in(ContainerUnit::allowedKeys())],
            'container_number' => ['nullable', 'string', 'max:120'],
            'vendor_trucking_id' => ['nullable', 'integer', 'exists:vendors,id'],
            'vendor_truck_id' => ['nullable', 'integer', 'exists:vendor_trucks,id'],
    ...
    {
        return ['lock_version' => 'versi data', 'subject' => 'nama pekerjaan', 'job_date' => 'tanggal job', 'expected_completion_date' => 'target selesai', 'service_type' => 'jenis layanan', 'origin' => 'asal', 'destination' => 'tujuan', 'shipment_reference' => 'referensi pengiriman', 'shipper_name' => 'pengirim', 'shipper_address' => 'alamat pengirim', 'consignee_name' => 'penerima', 'consignee_address' => 'alamat penerima', 'pol' => 'pelabuhan muat/POL', 'pod' => 'pelabuhan bongkar/POD', 'etd' => 'perkiraan berangkat/ETD', 'eta' => 'perkiraan tiba/ETA', 'vessel_voyage' => 'vessel & voyage', 'flight_number' => 'nomor penerbangan', 'bl_number' => 'nomor BL', 'hbl_number' => 'nomor HBL', 'awb_number' => 'nomor AWB', 'hawb_number' => 'nomor HAWB', 'booking_reference' => 'No AJU 6 digit terakhir', 'nopen' => 'Nomor Pendaftaran (Nopen)', 'nopen_date' => 'tanggal Nopen', 'npe_number' => 'nomor NPE', 'peb_number' => 'nomor PEB', 'peb_date' => 'tanggal PEB', 'sk_pabean_number' => 'nomor surat kuasa pabean', 'commercial_invoice_number' => 'nomor invoice', 'commercial_invoice_date' => 'tanggal invoice', 'packing_list_number' => 'nomor packing list', 'packing_list_date' => 'tanggal packing list', 'invoice_issuer' => 'nama penerbit invoice', 'invoice_amount' => 'nilai invoice', 'incoterm' => 'incoterm (CIF/FOB/EXW/DDP)', 'package_count' => 'jumlah paket', 'gross_weight' => 'berat kotor', 'volume' => 'volume muatan', 'container_type' => 'jenis kontainer', 'container_number' => 'nomor kontainer', 'vendor_trucking_id' => 'vendor trucking', 'vendor_truck_id' => 'armada/supir trucking', 'customer_address_id' => 'alamat pengiriman customer', 'truck_plate_number' => 'nomor plat truk', 'driver_name' => 'nama supir', 'driver_phone' => 'telepon supir', 'vehicle_type' => 'jenis kendaraan', 'delivery_address' => 'alamat tujuan pengiriman', 'sales_id' => 'sales', 'cs_id' => 'customer service', 'cargo_description' => 'Commodity (Nama Barang)', 'operational_notes' => 'catatan operasional'];
    }
}
