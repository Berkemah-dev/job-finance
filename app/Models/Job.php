            ...
            return [
                ...
                'items'           => [
                    ...
                    [
                        ...
                        'badge_color'  => $hasSpjm ? '#991b1b' : ($hasSppb ? '#166534' : '#b91c1c'),
                        'badge_bg'     => $hasSpjm ? '#fee2e2' : ($hasSppb ? '#dcfce7' : '#fee2e2'),
                    ],
                    [
                        'key'          => 'behandle',
                        ...
                        'badge_color'  => $hasBehandle ? '#92400e' : ($hasSppb && ! $hasSpjm ? '#166534' : '#b91c1c'),
                        'badge_bg'     => $hasBehandle ? '#fef3c7' : ($hasSppb && ! $hasSpjm ? '#dcfce7' : '#fee2e2'),
                    ],
                    [
                        'key'          => 'sppb',
                        'label'        => 'SPPB Final',
