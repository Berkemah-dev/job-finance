...
<section class="panel form-panel">
    ...
    <form class="data-form" method="POST" action="{{ route('bills-of-lading.update', $bl) }}">
        ...
        {{-- Status default / existing, dihilangkan dari form sesuai revisi client --}}
        <input type="hidden" name="status" value="{{ old('status', $bl->status) }}">
        ...
        <div class="form-grid">
            ...
            <div class="field">
                ...
                <input id="mbl_number" name="mbl_number" maxlength="100" value="{{ old('mbl_number', $bl->mbl_number) }}" placeholder="Nomor Master B/L (dari Job Order)">
        ...
        <div class="form-grid">
            ...
            <div class="field">
                ...
                <select id="agent_name" name="agent_name" data-custom-select data-allow-custom="true" aria-label="Agent">
                    ...
                    @php
                        $currentAgent = old('agent_name', $bl->agent_name);
                        $agentFound = false;
                    @endphp
            ...
            <div class="field">
                ...
                <select id="carrier" name="carrier" data-custom-select data-allow-custom="true" aria-label="Carrier (Pelayaran)">
                    ...
                    @php
                        $currentCarrier = old('carrier', $bl->carrier);
                        $carrierFound = false;
                    @endphp
            ...
            @php
                $hasSwitch = old('is_switch_bl', ($bl->shipper_switch || $bl->consignee_switch) ? '1' : '0') == '1';
            @endphp
            ...
            <div id="switch_bl_container" class="form-grid span-2" style="display: {{ $hasSwitch ? 'grid' : 'none' }}; grid-column: span 2; margin: 0; padding: 0;">
                <div class="field">
        ...
        <div class="form-grid">
            ...
            <div class="field">
                ...
                <select id="place_of_receipt" name="place_of_receipt" data-custom-select data-allow-custom="true" aria-label="Receipt">
                    ...
                    @php
                        $currentReceipt = old('place_of_receipt', $bl->place_of_receipt);
                        $receiptFound = false;
                    @endphp
                    @foreach($ports as $p)
            ...
            <div class="field">
                ...
                <select id="place_of_delivery" name="place_of_delivery" data-custom-select data-allow-custom="true" aria-label="Delivery">
                    ...
                    @php
                        $currentDelivery = old('place_of_delivery', $bl->place_of_delivery);
                        $deliveryFound = false;
                    @endphp
                    @foreach($ports as $p)
            ...
            <div class="field">
                ...
                <select id="final_destination" name="final_destination" data-custom-select data-allow-custom="true" aria-label="Destination">
                    ...
                    @php
                        $currentDest = old('final_destination', $bl->final_destination);
                        $destFound = false;
                    @endphp
                    @foreach($ports as $p)
        ...
        <div class="form-actions">
            ...
            <button class="button button-primary">Simpan Perubahan B/L</button>
        </div>
    </form>
</section>
