...
<div class="page-heading">
    <div>
        ...
        <p>Dokumen hak kepemilikan muatan laut untuk pengiriman export via kapal.</p>
    </div>
...
<section class="panel form-panel">
    <form class="data-form" method="POST" action="{{ route('bills-of-lading.store') }}" id="blForm">
        ...
        <div class="form-grid">
            ...
            <div class="field">
                ...
                <select id="bl_type" name="bl_type" required>
                    <option value="original" @selected(old('bl_type', 'original') === 'original')>Original B/L (3 set)</option>
        ...
        {{-- CARRIER & VESSEL --}}
        <div class="form-section-heading">
            <h2>Carrier & Informasi Kapal</h2>
            <p>Pelayaran, vessel, dan rute perjalanan kapal.</p>
        </div>
        ...
        <div class="form-grid">
            ...
            <div class="field">
                <label for="carrier_bl_number">No. B/L dari Pelayaran (Carrier B/L No.)</label>
                <input id="carrier_bl_number" name="carrier_bl_number" maxlength="100"
                    value="{{ old('carrier_bl_number') }}" placeholder="Nomor B/L yang diterbitkan pelayaran">
            </div>
            ...
            <div class="field">
                ...
                <input id="place_of_delivery" name="place_of_delivery" maxlength="120"
                    ...
                    placeholder="Tempat penyerahan akhir barang">
            </div>
        ...
        <div class="form-section-heading">
            ...
            <p>Identitas yang tercetak pada dokumen B/L resmi.</p>
        </div>
        ...
        <div class="form-grid">
            ...
            <div class="field">
                ...
                <input id="consignee_name" name="consignee_name" maxlength="160"
                    ...
                    placeholder="Nama Perusahaan Consignee / TO ORDER">
            </div>
            ...
            <div class="field span-2">
                ...
                <textarea id="notify_party" name="notify_party" rows="2"
                    placeholder="Nama & alamat pihak yang dinotifikasi atau 'SAME AS CONSIGNEE'">{{ old('notify_party', 'SAME AS CONSIGNEE') }}</textarea>
            </div>
        </div>

        {{-- RINCIAN KARGO (FORMAT 3 KOLOM B/L) --}}
        <div class="form-section-heading">
        ...
        <div class="form-grid">
            <div class="field">
                ...
                <textarea id="marks_numbers" name="marks_numbers" rows="4"
            ...
            <div class="field">
                ...
                <textarea id="cargo_description" name="cargo_description" rows="4"
                    placeholder="Uraian barang / kontainer">{{ old('cargo_description', $selectedJob?->cargo_description) }}</textarea>
            </div>

            <div class="field">
                <label for="gross_weight">G.W (Gross Weight - KGS)</label>
                <input id="gross_weight" name="gross_weight" inputmode="decimal"
                    value="{{ old('gross_weight', $selectedJob?->gross_weight) }}" placeholder="contoh: 14500.00">
            </div>

            <div class="field">
                <label for="net_weight">N.W (Net Weight - KGS)</label>
                <input id="net_weight" name="net_weight" inputmode="decimal"
                    value="{{ old('net_weight') }}" placeholder="contoh: 13800.00">
            </div>

            <div class="field">
                <label for="measurement">MEAS (Measurement / CBM)</label>
                <input id="measurement" name="measurement" inputmode="decimal"
                    value="{{ old('measurement', $selectedJob?->volume) }}" placeholder="contoh: 28.50">
            </div>
        </div>
        ...
        <div class="form-section-heading">
            ...
            <p>Instruksi khusus yang tercetak pada B/L.</p>
        </div>

        <div class="form-grid">
            <div class="field span-2">
                <label for="remarks">Remarks</label>
                <textarea id="remarks" name="remarks" rows="3">{{ old('remarks', "FREIGHT PREPAID\nPLEASE ISSUE ORIGINAL B/L 3/3") }}</textarea>
            </div>
        </div>
