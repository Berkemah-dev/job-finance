...
<div class="quote-actions" style="margin-bottom:20px; display:flex; gap:8px; flex-wrap:wrap; align-items:center;">
    <a class="button button-secondary" href="{{ route('bills-of-lading.preview', [$bl, 'type' => 'draft']) }}" target="_blank">📄 Cetak BL Draft</a>
    <a class="button button-secondary" href="{{ route('bills-of-lading.preview', [$bl, 'type' => 'original']) }}" target="_blank">📄 Cetak BL Original</a>
    <a class="button button-secondary" href="{{ route('bills-of-lading.preview', [$bl, 'type' => 'copy']) }}" target="_blank">📄 Cetak BL Copy</a>
