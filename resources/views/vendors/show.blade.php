...
@section('content')
<div class="page-heading"><div><p class="eyebrow">MASTER DATA</p><h1>{{ $vendor->code }}</h1><p>{{ $vendor->name }}</p></div><a class="text-link" href="{{ route('vendors.index') }}">Kembali ke daftar</a></div>
...
<section class="panel"><div class="panel-heading"><h2>Tarif trucking</h2><a class="text-link" href="{{ route('pricing.trucking.index') }}">Lihat tarif</a></div>
