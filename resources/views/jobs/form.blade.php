...
<div class="form-grid">
<div class="field"><label for="pol">Pelabuhan muat (POL)</label><input id="pol" name="pol" maxlength="120" value="{{ old('pol',$job->pol) }}" placeholder="Pelabuhan keberangkatan"></div>
...
<div class="field"><label for="bl_number">Nomor BL</label><input id="bl_number" name="bl_number" maxlength="60" value="{{ old('bl_number',$job->bl_number) }}" placeholder="Nomor MBL dari pelayaran"></div>
