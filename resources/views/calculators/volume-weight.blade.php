...
@section('content')
<div class="page-heading"><div><p class="eyebrow">KALKULATOR</p><h1>Volume Weight &amp; CBM</h1></div>    <a class="button button-secondary" href="{{ route('calculators.index') }}">← Kembali</a></div>
