...
<div class="field"><label for="is_active"><input id="is_active" type="checkbox" name="is_active" value="1" @checked(filter_var(old('is_active',$contact->is_active ?? 1), FILTER_VALIDATE_BOOL))> Kontak aktif</label></div>
</div>
