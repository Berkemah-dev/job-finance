...
@section('content')
<div class="page-heading"><div><p class="eyebrow">SALES & CUSTOMER</p><h1>{{ $contact->name }}</h1><p>{{ $contact->customer?->name }}</p></div><a class="button button-secondary" href="{{ route('customer-contacts.index') }}">← Kembali</a></div>
