...
@section('content')
<div class="page-heading"><div><p class="eyebrow">MASTER DATA</p><h1>Master TPS Air/Sea</h1><p>Kelola daftar Tempat Penimbunan Sementara (TPS) untuk moda udara dan laut.</p></div><a class="button button-primary" href="{{ route('tps.create') }}">+ Tambah TPS</a></div>
<section class="panel">
