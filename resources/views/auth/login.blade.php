...
<section class="login-story"><div class="login-story-overlay"></div><a class="brand login-brand-center" href="{{ route('login') }}"><img src="{{ asset('images/logo.png') }}" alt="JobFinance Logo" class="brand-img"></a></section>
