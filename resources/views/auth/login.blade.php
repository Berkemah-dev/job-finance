...
<section class="login-story"><div class="login-story-overlay"></div><a class="brand login-brand-center" href="{{ route('login') }}"><img src="{{ asset('images/logo.png') }}" alt="JobFinance Logo" class="brand-img"></a><div class="login-story-content"><span class="banner-tag">WORKSPACE KEUANGAN ANDA</span><h1>Pekerjaan terkelola.<br>Keuangan tertata.</h1><p>Dari penawaran hingga pembayaran, kelola setiap pekerjaan dengan lebih jelas dan terarah.</p><div class="login-feature"><x-icon name="check"/>Biaya dan profit per pekerjaan</div><div class="login-feature"><x-icon name="check"/>Tagihan dan pembayaran terintegrasi</div><div class="login-feature"><x-icon name="check"/>Akses sesuai peran tim Anda</div></div></section>
<main class="login-main"><div class="login-form"><p class="eyebrow">SELAMAT DATANG KEMBALI</p><h2>Masuk ke workspace</h2><p class="login-description">Gunakan akun Anda untuk melanjutkan.</p>
