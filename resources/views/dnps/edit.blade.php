        ...
        <div class="form-grid">
            ...
            <div class="field">
                ...
                <input id="invoice_value" name="invoice_value" inputmode="decimal"
                    value="{{ old('invoice_value', $dnp->invoice_value) }}" placeholder="contoh: 7,420.58">
            </div>

            <div class="field">
                <label for="freight">Biaya Transportasi</label>
                <input id="freight" name="freight" inputmode="decimal"
                    value="{{ old('freight', $dnp->freight) }}" placeholder="contoh: 1,225.00">
            </div>

            <div class="field">
                <label for="insurance">Asuransi</label>
                <input id="insurance" name="insurance" inputmode="decimal"
                    value="{{ old('insurance', $dnp->insurance) }}" placeholder="contoh: 30.00">
            </div>
            ...
            <div class="field">
                ...
                <select id="status" name="status" required>
                    <option value="draft" @selected(old('status', $dnp->status) === 'draft')>Draft</option>
                    <option value="submitted" @selected(old('status', $dnp->status) === 'submitted')>Submitted</option>
                    <option value="approved" @selected(old('status', $dnp->status) === 'approved')>Approved</option>
                    <option value="completed" @selected(old('status', $dnp->status) === 'completed')>Completed</option>
                    <option value="cancelled" @selected(old('status', $dnp->status) === 'cancelled')>Cancelled</option>
                </select>
            </div>
