...
<div class="title">DOKUMEN NOTA PABEAN (DNP)</div>
<div class="content">
<table>
    <tr><td class="label">Nomor DNP</td><td>: DNP-{{ $job->number }}/{{ now()->format('Y') }}</td></tr>
    <tr><td class="label">Nomor Job</td><td>: {{ $job->number }}</td></tr>
    <tr><td class="label">Tanggal</td><td>: {{ now()->format('d F Y') }}</td></tr>
    <tr><td class="label">Importir / Eksportir</td><td>: <strong>{{ $quotation->customer_snapshot['name'] }}</strong></td></tr>
...
<table style="margin-top:16px;border-top:2px solid #0f1f3d">
...
<div style="margin-top:24px;margin-left:10px"><p><em>Dokumen ini dibuat sebagai kelengkapan administrasi pabean dan pengiriman.</em></p></div>
