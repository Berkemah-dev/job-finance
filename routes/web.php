...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('document-types', DocumentTypeController::class)->except('show')->middleware('can:master-data.manage');
    // Master Data: Ports, ChargeTypes, ContainerUnits
    Route::get('/ports', [PortController::class, 'index'])->middleware('can:master-data.manage')->name('ports.index');
    Route::post('/ports', [PortController::class, 'store'])->middleware('can:master-data.manage')->name('ports.store');
    Route::patch('/ports/{port}/toggle', [PortController::class, 'toggle'])->middleware('can:master-data.manage')->name('ports.toggle');
    Route::delete('/ports/{port}', [PortController::class, 'destroy'])->middleware('can:master-data.manage')->name('ports.destroy');
    Route::get('/ports/{port}/edit', [PortController::class, 'edit'])->middleware('can:master-data.manage')->name('ports.edit');
    Route::put('/ports/{port}', [PortController::class, 'update'])->middleware('can:master-data.manage')->name('ports.update');
    Route::get('/charge-types', [ChargeTypeController::class, 'index'])->middleware('can:master-data.manage')->name('charge-types.index');
    Route::post('/charge-types', [ChargeTypeController::class, 'store'])->middleware('can:master-data.manage')->name('charge-types.store');
    Route::patch('/charge-types/{chargeType}/toggle', [ChargeTypeController::class, 'toggle'])->middleware('can:master-data.manage')->name('charge-types.toggle');
    Route::delete('/charge-types/{chargeType}', [ChargeTypeController::class, 'destroy'])->middleware('can:master-data.manage')->name('charge-types.destroy');
    Route::get('/charge-types/{chargeType}/edit', [ChargeTypeController::class, 'edit'])->middleware('can:master-data.manage')->name('charge-types.edit');
    Route::put('/charge-types/{chargeType}', [ChargeTypeController::class, 'update'])->middleware('can:master-data.manage')->name('charge-types.update');
    Route::get('/container-units', [ContainerUnitController::class, 'index'])->middleware('can:master-data.manage')->name('container-units.index');
    Route::post('/container-units', [ContainerUnitController::class, 'store'])->middleware('can:master-data.manage')->name('container-units.store');
    Route::patch('/container-units/{containerUnit}/toggle', [ContainerUnitController::class, 'toggle'])->middleware('can:master-data.manage')->name('container-units.toggle');
    Route::delete('/container-units/{containerUnit}', [ContainerUnitController::class, 'destroy'])->middleware('can:master-data.manage')->name('container-units.destroy');
    Route::get('/container-units/{containerUnit}/edit', [ContainerUnitController::class, 'edit'])->middleware('can:master-data.manage')->name('container-units.edit');
    Route::put('/container-units/{containerUnit}', [ContainerUnitController::class, 'update'])->middleware('can:master-data.manage')->name('container-units.update');
    Route::get('/service-types', [ServiceTypeController::class, 'index'])->middleware('can:master-data.manage')->name('service-types.index');
    Route::post('/service-types', [ServiceTypeController::class, 'store'])->middleware('can:master-data.manage')->name('service-types.store');
    Route::patch('/service-types/{serviceType}/toggle', [ServiceTypeController::class, 'toggle'])->middleware('can:master-data.manage')->name('service-types.toggle');
    ...
    Route::get('/master/charge-types', [AccountController::class, 'index'])->defaults('tab', 'charge')->middleware('can:master-data.manage')->name('master.charge');
    Route::get('/master/units', [AccountController::class, 'index'])->defaults('tab', 'unit')->middleware('can:master-data.manage')->name('master.units');
    Route::get('/master/ports', [AccountController::class, 'index'])->defaults('tab', 'port')->middleware('can:master-data.manage')->name('master.ports');
