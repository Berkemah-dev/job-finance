...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/service-types', [ServiceTypeController::class, 'index'])->middleware('can:jobs.manage')->name('service-types.index');
    Route::post('/service-types', [ServiceTypeController::class, 'store'])->middleware('can:jobs.manage')->name('service-types.store');
    Route::patch('/service-types/{serviceType}/toggle', [ServiceTypeController::class, 'toggle'])->middleware('can:jobs.manage')->name('service-types.toggle');
    Route::delete('/service-types/{serviceType}', [ServiceTypeController::class, 'destroy'])->middleware('can:jobs.manage')->name('service-types.destroy');
    Route::get('/service-types/{serviceType}/edit', [ServiceTypeController::class, 'edit'])->middleware('can:jobs.manage')->name('service-types.edit');
    Route::put('/service-types/{serviceType}', [ServiceTypeController::class, 'update'])->middleware('can:jobs.manage')->name('service-types.update');
